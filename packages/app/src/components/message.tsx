...
export const ToolCall = memo(function ToolCall({
  ...
  if (presentation.isPlan) {
    let planText = "";
    let planOutcome: typeof presentation.planOutcome = undefined;
    if (effectiveDetail?.type === "plan") {
      planText = effectiveDetail.text;
      planOutcome = presentation.planOutcome;
    } else if (effectiveDetail?.type === "plain_text") {
      planText = (effectiveDetail as { text?: string }).text ?? "";
    }
    if (planText) {
      return (
        <PlanCard
